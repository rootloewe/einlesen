...
| [ZIP-Archiv](https://github.com/rootloewe/einlesen/releases/download/v2.5.4/einlesen.zip)<br>(x86_64)                                    | [DMG-Archiv] not yet <br>(Intel)                                                                                                             | [deb-Installer](https://github.com/rootloewe/einlesen/releases/download/v2.5.4/einlesen.deb)<br>(x86_64)                                  |
